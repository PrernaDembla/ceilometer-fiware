...
from netaddr import *
from ceilometer_fiware.region import OSVersionComponent
    ...
    def get_samples(self, manager, cache, resources):
        ...
        if nL and "networks" in nL:
            for nLi in nL["networks"]:
                if ("id" in nLi) and ("name" in nLi) and nLi["name"] in netlist and  ("subnets" in nLi):
